...
export const DoodadType = {
  ...
  // the same tile and hangs an AreaTrigger off that. Centred on its tile like
  // Cover, since the art is a flat 16x16 decal with no overhang.
  // [EMITTED] — the path is taken from a hand-edited level6 that loaded.
