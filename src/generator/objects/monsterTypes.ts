...
export const MONSTER_TYPES: MonsterTypeDef[] = [
  ...
  { id: 'archer3', configKey: 'maxArchers3', upgradeChance: 1.0, defaultMax: 0, group: 'Classic', acts: [2, 4], tiers: ['actors/archer_3.xml'] },
  ...
  { id: 'bat2', configKey: 'maxBats2', upgradeChance: 1.0, defaultMax: 0, group: 'Classic', acts: [1], tiers: ['actors/spawners/bats.xml', 'actors/bat_2.xml', 'actors/bat_3.xml'] },
  ...
  { id: 'tick2', configKey: 'maxTicks2', upgradeChance: 1.0, defaultMax: 0, group: 'Classic', acts: [1], tiers: ['actors/tick_2_small.xml', 'actors/tick_2.xml'] },
  ...
  { id: 'tower_flower1_small', configKey: 'maxTowers_Flower1_Small', upgradeChance: 1.0, defaultMax: 0, group: 'Towers', acts: [1, 3], tiers: ['actors/tower_flower_1_small.xml'] },
  { id: 'tower_flower2', configKey: 'maxTowers_Flower2', upgradeChance: 1.0, defaultMax: 0, group: 'Towers', acts: [1, 3], tiers: ['actors/tower_flower_2.xml'] },
  { id: 'tower_flower3', configKey: 'maxTowers_Flower3', upgradeChance: 1.0, defaultMax: 0, group: 'Towers', acts: [1, 3], tiers: ['actors/tower_flower_3.xml'] },
  { id: 'tower_nova1', configKey: 'maxTowers_Nova1', upgradeChance: 1.0, defaultMax: 0, group: 'Towers', acts: [2, 3, 4], tiers: ['actors/tower_nova_1.xml'] },
  { id: 'tower_nova2', configKey: 'maxTowers_Nova2', upgradeChance: 1.0, defaultMax: 0, group: 'Towers', acts: [2, 3, 4], tiers: ['actors/tower_nova_2.xml'] },
  ...
  { id: 'wisp2', configKey: 'maxWisps2', upgradeChance: 1.0, defaultMax: 0, group: 'Classic', acts: [3, 4], tiers: ['actors/wisp_2.xml'] },
